...
**참고**: CLI Direct DB 연결 실패 시 [SUPABASE_CONNECTION_TROUBLESHOOTING.md](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) 참조.
...
**원인**: PC + VPN 환경에서 Direct DB(`db.<ref>.supabase.co`) IPv6 불안정/차단. [SUPABASE_CONNECTION_TROUBLESHOOTING](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) 참조.
...
- [PHASE4_CSV_LOADING_PLAN.md](./PHASE4_CSV_LOADING_PLAN.md) - Phase 4 CSV 적재
- [PHASE5_GATE1_QA_PLAN.md](./PHASE5_GATE1_QA_PLAN.md) - Phase 5 Gate 1 QA
...
- [DASHBOARD_DATA_INTEGRATION_PROGRESS.md](./DASHBOARD_DATA_INTEGRATION_PROGRESS.md) - Phase 2~6·대시보드 반영 진행
