...
graph TB
    subgraph "UnifiedLayout"
        Header[HeaderBar<br/>56px height]
        
        subgraph "Main Content Area"
            MapView[MapView<br/>flex-1<br/>deck.gl + maplibre-gl]
            RightPanel[RightPanel<br/>w-80 320px<br/>Desktop only]
        end
        
        subgraph "HVDC Panel"
            KpiStrip[KpiStrip<br/>Real-time KPIs]
            WorklistTable[WorklistTable<br/>Gate Logic]
            DetailDrawer[DetailDrawer<br/>Detail Panel]
        end
    end

    MapView --> KpiStrip
    RightPanel --> WorklistTable
    KpiStrip --> DetailDrawer
```
...
graph TD
    ...
    MapView --> LocationLayer[Location Layer<br/>deck.gl ScatterplotLayer]
