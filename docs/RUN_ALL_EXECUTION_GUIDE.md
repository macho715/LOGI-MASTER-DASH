...
> **최종 업데이트**: 2026-01-25  
> **참조 문서**: [DATA_LOADING_PLAN.md](./DATA_LOADING_PLAN.md), [REPO_EXECUTION_GUIDE_HVDC_DATA_LOADING.md](../REPO_EXECUTION_GUIDE_HVDC_DATA_LOADING.md), [DATA_LOADING_RUNBOOK.md](./DATA_LOADING_RUNBOOK.md)
...
자세한 내용: [SUPABASE_CONNECTION_TROUBLESHOOTING.md](./SUPABASE_CONNECTION_TROUBLESHOOTING.md)
...
자세한 내용: [SUPABASE_CONNECTION_STRING_GUIDE.md](./SUPABASE_CONNECTION_STRING_GUIDE.md)
...
- [DATA_LOADING_RUNBOOK.md](./DATA_LOADING_RUNBOOK.md) - 상세 Runbook
- [DATA_LOADING_PLAN.md](./DATA_LOADING_PLAN.md) - 단계별 계획

### Phase별 상세 플랜
- [PHASE2_DDL_APPLICATION_PLAN.md](./PHASE2_DDL_APPLICATION_PLAN.md) - DDL 적용
- [PHASE4_CSV_LOADING_PLAN.md](./PHASE4_CSV_LOADING_PLAN.md) - CSV 적재
- [PHASE5_GATE1_QA_PLAN.md](./PHASE5_GATE1_QA_PLAN.md) - Gate 1 QA
- [PHASE6_REALTIME_ACTIVATION_PLAN.md](./PHASE6_REALTIME_ACTIVATION_PLAN.md) - Realtime 활성화

### 연결 및 트러블슈팅
- [SUPABASE_CONNECTION_STRING_GUIDE.md](./SUPABASE_CONNECTION_STRING_GUIDE.md) - 연결 문자열 찾기
...
- [SUPABASE_UPLOAD_DATA_LOCATIONS.md](./SUPABASE_UPLOAD_DATA_LOCATIONS.md) - 실제 데이터 위치
- [SUPABASE_OPTIONC_EMPTY_DATA_ANALYSIS.md](./SUPABASE_OPTIONC_EMPTY_DATA_ANALYSIS.md) - Option-C 빈 데이터 원인 분석
