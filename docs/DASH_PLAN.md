...
> **최종 업데이트**: 2026-01-25 (누락 점검 반영, 진행 체크리스트 추가)
...
- [ ] Phase 2~6 완료, `public.shipments`·Worklist API 연동 확인 ([DASHBOARD_DATA_INTEGRATION_PROGRESS](./DASHBOARD_DATA_INTEGRATION_PROGRESS.md)).
...
| 검증 §4 | [ ] 11 POI·줌·툴팁·StageCardsStrip·GlobalSearch (수동 체크) |
...
- [DASHBOARD_DATA_INTEGRATION_PROGRESS.md](./DASHBOARD_DATA_INTEGRATION_PROGRESS.md) — Phase 2~6·대시보드 반영.
