...
👉 [SUPABASE_DASHBOARD_IMPORT_GUIDE.md](./SUPABASE_DASHBOARD_IMPORT_GUIDE.md)

### 대안 2: 다른 업로드 방법
👉 [SUPABASE_UPLOAD_METHODS.md](./SUPABASE_UPLOAD_METHODS.md)

---

## 📚 관련 문서

- [FIX_DNS_RESOLUTION.md](./FIX_DNS_RESOLUTION.md) - 상세 해결 가이드
- [SUPABASE_CONNECTION_TROUBLESHOOTING.md](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) - 연결 문제 종합 가이드
