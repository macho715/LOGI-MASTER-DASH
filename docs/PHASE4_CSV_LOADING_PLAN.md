...
**참고**: `psycopg` (v3) 사용. VPN/failed to resolve 시 [연결 문제 해결](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) 참조. DB URL 전체는 문서/로그에 남기지 말고 `user:***@host` 형태로 마스킹.
...
**해결**:
- [SUPABASE_CONNECTION_TROUBLESHOOTING.md](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) 참조
