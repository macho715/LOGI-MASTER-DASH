...
#### `apps/logistics-dashboard/` (포트 3000)
...
- **핵심 컴포넌트**:
  ...
  - `components/dashboard/RightPanel.tsx` - 우측 상태 패널
  - `components/hvdc/KpiStrip.tsx`, `WorklistTable.tsx`, `DetailDrawer.tsx` - HVDC 패널
- **API**: `/api/worklist` - KPI/Worklist 데이터 엔드포인트
- **Realtime**: `hooks/useKpiRealtime.ts` - Supabase Realtime 기반 KPI 업데이트
- **기술**: Next.js 15, React 19, TypeScript, Zustand, Tailwind CSS 4
...
**상세 가이드**: [ETL_GUIDE.md](./ETL_GUIDE.md), [DATA_LOADING_PLAN.md](./DATA_LOADING_PLAN.md)
...
2. **[PROJECT_SUMMARY.md](../PROJECT_SUMMARY.md)** - 한눈에 보는 개발 현황 (60% 완료)
3. **[DASHBOARD_LAYOUT.md](./DASHBOARD_LAYOUT.md)** - 대시보드 레이아웃 사양 (3패널 구조)

#### 데이터 통합 문서
4. **[ETL_GUIDE.md](./ETL_GUIDE.md)** - ETL 스크립트 사용 가이드
5. **[DATA_LOADING_PLAN.md](./DATA_LOADING_PLAN.md)** - 데이터 적재 단계별 실행 계획
6. **[architecture.md](./architecture.md)** - 시스템 아키텍처 (데이터 흐름, Realtime)

#### 통합 로드맵
7. **[INTEGRATION_ROADMAP.md](./INTEGRATION_ROADMAP.md)** - 통합 로드맵 (Phase별 작업)
...
- [DATA_LOADING_PLAN.md](./DATA_LOADING_PLAN.md) 참조

### 4. 레이아웃 확인
- `apps/logistics-dashboard/components/UnifiedLayout.tsx` 확인
- [DASHBOARD_LAYOUT.md](./DASHBOARD_LAYOUT.md) 참조

### 5. 문서 읽기 순서
1. [PROJECT_SUMMARY.md](../PROJECT_SUMMARY.md) - 전체 현황 파악
2. [AGENTS.md](../AGENTS.md) - 코딩 규칙 이해
3. [DASHBOARD_LAYOUT.md](./DASHBOARD_LAYOUT.md) - 레이아웃 구조 이해
4. [architecture.md](./architecture.md) - 시스템 아키텍처 이해
...
- [NEXT_STEPS_PRIORITY.md](./NEXT_STEPS_PRIORITY.md) - 우선순위 및 실행 계획
