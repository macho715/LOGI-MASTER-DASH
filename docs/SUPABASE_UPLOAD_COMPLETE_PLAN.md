...
> **최종 업데이트**: 2026-01-25  
> **참조**: [DATA_LOADING_PLAN.md](./DATA_LOADING_PLAN.md), [DATA_LOADING_RUNBOOK.md](./DATA_LOADING_RUNBOOK.md), [DASHBOARD_DATA_INTEGRATION_PROGRESS.md](./DASHBOARD_DATA_INTEGRATION_PROGRESS.md)
...
- **VPN/failed to resolve/SSL reset** → [SUPABASE_CONNECTION_TROUBLESHOOTING](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) (Session pooler 5432). **Redaction**: DB URL/비밀번호 로그·문서 기입 금지.
...
**상세**: [PHASE2_DDL_APPLICATION_PLAN.md](./PHASE2_DDL_APPLICATION_PLAN.md)
...
- **대안**: `SUPABASE_DB_URL` 또는 `--db-url` (Session 5432 권장, `--connect-timeout 10` 권장) 설정 후 `python scripts/hvdc/load_csv.py [--db-url URL] [--truncate] --status-only`. VPN/Pooler → [SUPABASE_CONNECTION_TROUBLESHOOTING](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) (Session pooler 5432).
- **고급**: Supabase CLI + SQL
...
**상세**: [PHASE4_CSV_LOADING_PLAN.md](./PHASE4_CSV_LOADING_PLAN.md)
...
**실행 방법**:
- **권장**: `SUPABASE_DB_URL` (Session 5432 권장) 설정 후 `run_gate1_qa.ps1` 또는 `.sh`. **대안**: Supabase Dashboard SQL Editor에서 `gate1_qa.sql` 실행. VPN/Pooler → [SUPABASE_CONNECTION_TROUBLESHOOTING](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) (Session pooler 5432).
...
**상세**: [PHASE5_GATE1_QA_PLAN.md](./PHASE5_GATE1_QA_PLAN.md)
...
**실행 방법**:
- **권장**: Supabase CLI `db execute -f supabase/migrations/20260124_enable_realtime_layers.sql` (link 필요). **대안**: Supabase Dashboard SQL Editor (최종 비상로). VPN/failed to resolve → [SUPABASE_CONNECTION_TROUBLESHOOTING](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) (Session pooler 5432) 또는 Dashboard.
...
**상세**: [PHASE6_REALTIME_ACTIVATION_PLAN.md](./PHASE6_REALTIME_ACTIVATION_PLAN.md)
...
#### Phase 2 문제
- CLI 미설치: [PHASE2_DDL_APPLICATION_PLAN.md](./PHASE2_DDL_APPLICATION_PLAN.md#문제-해결) 참조
- 연결 오류: [SUPABASE_CONNECTION_TROUBLESHOOTING.md](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) 참조

#### Phase 4 문제
- CSV 인코딩 오류: [PHASE4_CSV_LOADING_PLAN.md](./PHASE4_CSV_LOADING_PLAN.md#문제-해결) 참조
- FK 제약 위반: 적재 순서 확인
...
### Phase별 상세 플랜
- [Phase 2: DDL 적용 플랜](./PHASE2_DDL_APPLICATION_PLAN.md)
- [Phase 4: CSV 적재 플랜](./PHASE4_CSV_LOADING_PLAN.md)
- [Phase 5: Gate 1 QA 플랜](./PHASE5_GATE1_QA_PLAN.md)
- [Phase 6: Realtime 활성화 플랜](./PHASE6_REALTIME_ACTIVATION_PLAN.md)
...
- [SUPABASE_CONNECTION_TROUBLESHOOTING.md](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) - 연결 문제 해결
