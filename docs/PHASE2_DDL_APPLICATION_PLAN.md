...
> **최종 업데이트**: 2026-01-25  
> **참조**: [DATA_LOADING_PLAN.md](./DATA_LOADING_PLAN.md), [DATA_LOADING_RUNBOOK.md](./DATA_LOADING_RUNBOOK.md), [SUPABASE_CONNECTION_TROUBLESHOOTING.md](./SUPABASE_CONNECTION_TROUBLESHOOTING.md)
...
**참고**: CLI Direct DB 연결 실패 시(VPN/IPv6) [SUPABASE_CONNECTION_TROUBLESHOOTING.md](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) 참조.
...
**상세**: [SUPABASE_CONNECTION_TROUBLESHOOTING.md](./SUPABASE_CONNECTION_TROUBLESHOOTING.md) (VPN / IPv6 / Pooler) 참조. 대안으로 Supabase Dashboard SQL Editor 사용 (네트워크 문제 우회).
...
1. **Phase 4: CSV 적재**
   ...
   - 참조: [PHASE4_CSV_LOADING_PLAN.md](./PHASE4_CSV_LOADING_PLAN.md)

2. **Phase 5: Gate 1 QA**
   - Orphan/Duplicate/Flow Code 규칙 검증
   - 참조: [PHASE5_GATE1_QA_PLAN.md](./PHASE5_GATE1_QA_PLAN.md)

3. **Phase 6: Realtime 활성화**
   - Realtime publication 활성화
   - 참조: [PHASE6_REALTIME_ACTIVATION_PLAN.md](./PHASE6_REALTIME_ACTIVATION_PLAN.md)
